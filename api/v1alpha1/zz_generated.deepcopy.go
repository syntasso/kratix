...
func (in *DestinationSpec) DeepCopyInto(out *DestinationSpec) {
	*out = *in
	...
	out.FilepathExpression = in.FilepathExpression
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FilepathExpression) DeepCopyInto(out *FilepathExpression) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FilepathExpression.
func (in *FilepathExpression) DeepCopy() *FilepathExpression {
	if in == nil {
		return nil
	}
	out := new(FilepathExpression)
	in.DeepCopyInto(out)
	return out
}
