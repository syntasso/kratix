...
func (in *SchedulingPolicy) DeepCopyInto(out *SchedulingPolicy) {
	*out = *in
	if in.PromiseNames != nil {
		in, out := &in.PromiseNames, &out.PromiseNames
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.Rules != nil {
		in, out := &in.Rules, &out.Rules
		*out = make([]SchedulingPolicyRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SchedulingPolicyRule) DeepCopyInto(out *SchedulingPolicyRule) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SchedulingPolicyRule.
func (in *SchedulingPolicyRule) DeepCopy() *SchedulingPolicyRule {
	if in == nil {
		return nil
	}
	out := new(SchedulingPolicyRule)
	in.DeepCopyInto(out)
	return out
}
