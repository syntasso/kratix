...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ClusterRolesLabels) DeepCopyInto(out *ClusterRolesLabels) {
	{
		in := &in
		*out = make(ClusterRolesLabels, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterRolesLabels.
func (in ClusterRolesLabels) DeepCopy() ClusterRolesLabels {
	if in == nil {
		return nil
	}
	out := new(ClusterRolesLabels)
	in.DeepCopyInto(out)
	return *out
}
...
func (in *PromiseSpec) DeepCopyInto(out *PromiseSpec) {
	*out = *in
	...
	if in.ClusterRolesLabels != nil {
		in, out := &in.ClusterRolesLabels, &out.ClusterRolesLabels
		*out = make(ClusterRolesLabels, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
