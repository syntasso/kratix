...
func (in *PromiseSpec) DeepCopyInto(out *PromiseSpec) {
	*out = *in
	...
	if in.WorkerResources != nil {
		...
		*out = make([]WorkerResource, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkerResource) DeepCopyInto(out *WorkerResource) {
	*out = *in
	in.Unstructured.DeepCopyInto(&out.Unstructured)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkerResource.
func (in *WorkerResource) DeepCopy() *WorkerResource {
	if in == nil {
		return nil
	}
	out := new(WorkerResource)
	in.DeepCopyInto(out)
	return out
}
