...
func (in *KratixPromiseStatus) DeepCopyInto(out *KratixPromiseStatus) {
	*out = *in
	...
	if in.Workflows != nil {
		...
		*out = make(WorkflowsStatus, len(*in))
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in WorkflowsStatus) DeepCopyInto(out *WorkflowsStatus) {
	{
		in := &in
		*out = make(WorkflowsStatus, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkflowsStatus.
func (in WorkflowsStatus) DeepCopy() WorkflowsStatus {
	if in == nil {
		return nil
	}
