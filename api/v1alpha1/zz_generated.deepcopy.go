...
func (in *PromiseSpec) DeepCopyInto(out *PromiseSpec) {
	*out = *in
	...
	in.SchedulingField.DeepCopyInto(&out.SchedulingField)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SchedulingField) DeepCopyInto(out *SchedulingField) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SchedulingField.
func (in *SchedulingField) DeepCopy() *SchedulingField {
	if in == nil {
		return nil
	}
	out := new(SchedulingField)
	in.DeepCopyInto(out)
	return out
}
...
func (in *WorkflowTriggers) DeepCopyInto(out *WorkflowTriggers) {
	*out = *in
	if in.Gummybear != nil {
		in, out := &in.Gummybear, &out.Gummybear
...
func (in *Workflows) DeepCopyInto(out *Workflows) {
	*out = *in
	in.Grapefruit.DeepCopyInto(&out.Grapefruit)
}
