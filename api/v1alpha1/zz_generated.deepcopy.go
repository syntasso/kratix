...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PathField) DeepCopyInto(out *PathField) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PathField.
func (in *PathField) DeepCopy() *PathField {
	if in == nil {
		return nil
	}
	out := new(PathField)
