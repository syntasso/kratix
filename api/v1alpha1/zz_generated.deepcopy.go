...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FeatureFlagSelectors) DeepCopyInto(out *FeatureFlagSelectors) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FeatureFlagSelectors.
func (in *FeatureFlagSelectors) DeepCopy() *FeatureFlagSelectors {
	if in == nil {
		return nil
	}
	out := new(FeatureFlagSelectors)
	in.DeepCopyInto(out)
	return out
}
...
func (in *FeatureFlagSpec) DeepCopyInto(out *FeatureFlagSpec) {
	*out = *in
	in.DestinationSelectors.DeepCopyInto(&out.DestinationSelectors)
}
...
func (in *PromisePipelines) DeepCopyInto(out *PromisePipelines) {
	*out = *in
	...
	if in.ConfigureResource != nil {
		in, out := &in.ConfigureResource, &out.ConfigureResource
		*out = make([]Pipeline, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ConfigurePromise != nil {
		in, out := &in.ConfigurePromise, &out.ConfigurePromise
		*out = make([]Pipeline, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.DeletePromise != nil {
		in, out := &in.DeletePromise, &out.DeletePromise
		*out = make([]Pipeline, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
