...
type PromiseSpec struct {
	...
	// Labels to add to ClusterRoles generated by Kratix for this Promise.
	//
	// Typical use is RBAC aggregation labels, for example:
	// rbac.authorization.k8s.io/aggregate-to-admin: "true"
	// rbac.authorization.k8s.io/aggregate-to-edit: "true"
	//
	// These labels are applied to generated ClusterRoles so permissions can be
	// aggregated into Kubernetes default user-facing roles.
	ClusterRolesLabels ClusterRolesLabels `json:"clusterRolesLabels,omitempty"`
}
...
// ClusterRolesLabels defines labels to apply to Promise-generated ClusterRoles.
//
// This is commonly used for Kubernetes RBAC aggregation labels.
type ClusterRolesLabels map[string]string

// {
// // Name of the ClusterRole to aggregate
// Name string `json:"name,omitempty"`
// // Aggregation label to be added to the ClusterRole identified by Name
// AggregationLabels []AggregationMap `json:"aggregationLabels:omitempty"`
// }
...
// GenerateLabelsForClusterRole returns the Promise-defined labels
// that should be applied to generated ClusterRoles.
func (p *Promise) GenerateLabelsForClusterRole() map[string]string {
	if p.Spec.ClusterRolesLabels == nil {
		return map[string]string{}
	}
	return p.Spec.ClusterRolesLabels
}
